...
final fileprivate class RepeatWhenSequence<S: Sequence, TriggerObservable: ObservableType> : Producer<S.Iterator.Element.Element> where S.Iterator.Element : ObservableType {
...
: ObserverType where S.Iterator.Element : ObservableType, S.Iterator.Element.Element == O.Element {
    typealias E = TriggerObservable.Element
